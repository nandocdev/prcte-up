...
---
*Nota: Los nombres de estados entre comillas dobles corresponden exactamente a los valores en la tabla `work_statuses` de la base de datos. Los trabajos rechazados o devueltos establecen `is_draft = '1'` para permitir la edición por parte del profesor.*