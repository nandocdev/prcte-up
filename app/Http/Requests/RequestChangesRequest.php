...
/**
 * Form Request: Solicitar Correcciones por VIEX
 *
 * Valida los datos para solicitar correcciones a un trabajo por VIEX.
 */
        ...
        $validator->after(function ($validator) {
            ...
            if ($work && $work->currentStatus->name !== 'En VIEX - En Evaluación') {
                $validator->errors()->add(
                    'work',
                    __('El trabajo debe estar en estado "En VIEX - En Evaluación" para solicitar correcciones.')
                );
            }
        });
    }
