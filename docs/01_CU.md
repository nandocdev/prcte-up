...
| **UC-DOC-007** | **Ver comentarios y retroalimentación** de coordinadores/evaluadores                           | Alta      | Parcialmente Implementado |
...
| **UC-DOC-013** | **Comunicarse con coordinador** vía chat interno o comentarios                                 | Media     | No Implementado |
| **UC-DOC-014** | **Visualizar historial completo** de trámites por trabajo                                      | Alta      | Implementado |
| **UC-DOC-015** | **Generar reporte personal** de trabajos aprobados (PDF/Excel)                                 | Media     | No Implementado |
