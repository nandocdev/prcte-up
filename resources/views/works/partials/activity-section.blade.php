                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('modality') is-invalid @enderror"
                        ...
                        @foreach($workTypesConfig['modalities'] ?? [] as $value => $label)
                            <option value="{{ $value }}" {{ old('modality') == $value ? 'selected' : '' }}>
                                {{ __($label) }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('duration_hours') is-invalid @enderror"
                        ...
                        value="{{ old('duration_hours') }}" placeholder="{{ __('Ej: 20') }}">
        ...
        <div class="form-group">
            <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input" id="offers_certificate"
                    name="offers_certificate" value="1" {{ old('offers_certificate') ? 'checked' : '' }}>
