        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    @if(auth()->user()->hasRole(['super_admin', 'viex_admin']))
                    <div class="col-md-6 col-lg-4 mb-3">
                        <a href="{{ route('documentation.show', 'administration') }}" class="text-decoration-none">
                            <div class="card bg-gradient-dark h-100">
                                <div class="card-body text-center text-white">
                                    <i class="fas fa-cogs fa-3x mb-3"></i>
                                    <h5>Administración del Sistema</h5>
                                    <p class="mb-0">Panel administrativo y catálogos</p>
                                </div>
                            </div>
                        </a>
                    </div>
