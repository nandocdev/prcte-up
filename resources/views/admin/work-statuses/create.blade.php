...
@section('title', __('Nuevo estado de trabajo'))
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.work-statuses.store') }}" method="POST">
                @csrf
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> {{ __('Guardar estado') }}
                    </button>
                </div>
            </form>
        </div>
