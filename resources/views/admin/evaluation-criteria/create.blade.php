...
@section('title', __('Nuevo criterio de evaluacion'))
...
<div class="row">
    <div class="col-sm-6">
        <h1 class="m-0">
            ...
            {{ __('Nuevo criterio de evaluacion') }}
        </h1>
    </div>
    <div class="col-sm-6">
            ...
            <form action="{{ route('admin.evaluation-criteria.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" maxlength="200" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="category" name="category" class="form-control @error('category') is-invalid @enderror" maxlength="100" value="{{ old('category') }}">
                        @error('category')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" id="max_score" name="max_score" class="form-control @error('max_score') is-invalid @enderror" min="1" max="100" value="{{ old('max_score', 10) }}" required>
                            @error('max_score')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" id="weight" name="weight" class="form-control @error('weight') is-invalid @enderror" min="0" max="100" value="{{ old('weight', 5) }}" required>
                            @error('weight')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" id="order" name="order" class="form-control @error('order') is-invalid @enderror" min="0" max="1000" value="{{ old('order', 0) }}" required>
                            @error('order')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            <input type="checkbox" class="custom-control-input" id="is_required" name="is_required" value="1" {{ old('is_required', true) ? 'checked' : '' }}>
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> {{ __('Guardar criterio') }}
                    </button>
                </div>
            </form>
        </div>
