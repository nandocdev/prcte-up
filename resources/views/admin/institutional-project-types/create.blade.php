...
@section('title', __('Nuevo tipo institucional'))
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title mb-0">
                    ...
                    {{ __('Datos del tipo institucional') }}
                </h3>
            </div>

            <form action="{{ route('admin.institutional-project-types.store') }}" method="POST">
                @csrf
